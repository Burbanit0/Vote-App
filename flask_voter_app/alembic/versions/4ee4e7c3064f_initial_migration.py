...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['candidate_id'], ['candidate.id'], name='vote_candidate_id_fkey'),
    sa.ForeignKeyConstraint(['voter_id'], ['voter.id'], name='vote_voter_id_fkey'),
    ...
    sa.Column('vote_type', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['candidate_id'], ['candidate.id'], name='result_candidate_id_fkey'),
