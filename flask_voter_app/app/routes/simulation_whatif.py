"""
simulation_whatif.py — "What-if" comparative analysis endpoint.

Runs the same base scenario repeatedly while varying a single parameter,
returning winners and support scores for each method at every value.
Used by the /what-if frontend page.
"""
