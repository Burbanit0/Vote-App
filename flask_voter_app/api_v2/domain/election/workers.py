...
from api_v2.engine.utils.simulation_voting_utils import calculate_utility, create_candidate, create_voter
...
from api_v2.engine.utils.simulation_multiwinner_utils import (
    get_stv_result, get_dhondt_winners,
    get_spav_result, get_phragmen_result,
)
from api_v2.engine.utils.blank_contagion         import simulate_blank_contagion
from api_v2.engine.utils.campaign_dynamics       import simulate_campaign
from api_v2.engine.utils.information_model       import apply_information_asymmetry
from api_v2.engine.utils.cache import cache_result
...
def _snapshot_election_winners(
    ...
    from api_v2.engine.utils.simulation_score_utils import (
...
def _combined_effects_worker(data: Dict[str, Any]) -> tuple[Dict[str, Any], int]:
    ...
    """
    import copy
    from api_v2.engine.utils.simulation_ranked_utils import get_condorcet_winner
...
def _nota_worker(data: Dict[str, Any]) -> tuple[Dict[str, Any], int]:
    ...
    from api_v2.engine.utils.simulation_score_utils import get_majority_judgment_winner as _mj
...
def _choice_overload_worker(data: Dict[str, Any]) -> tuple[Dict[str, Any], int]:
    ...
    from api_v2.engine.utils.simulation_score_utils import get_majority_judgment_winner as _mj_co
    from api_v2.engine.utils.simulation_ranked_utils import (
