"""
api_v2.domain.simulations.whatif — "What-if" comparative analysis worker.
...
from api_v2.engine.utils.simulation_voting_utils import Voter, create_voter, create_candidate
