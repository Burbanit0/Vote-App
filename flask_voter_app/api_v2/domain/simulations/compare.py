...
from api_v2.engine.utils.simulation_voting_utils import calculate_utility, compute_strategic_plurality_vote, create_candidate, create_voter
from api_v2.engine.utils.simulation_ranked_utils import get_plurality_winner
from api_v2.engine.utils.simulation_metrics import compare_all_methods, compare_all_methods_mc, get_condorcet_matrix
from api_v2.engine.utils.arrow_criteria import check_all_criteria
from api_v2.engine.utils.blank_vote_rules import BlankVoteRule, apply_blank_rule
from api_v2.engine.utils.information_model import apply_information_asymmetry, compute_information_gap
...
def _manipulability_worker(params: Dict[str, Any]) -> Tuple[Dict[str, Any], int]:
    ...
    from api_v2.engine.utils.gibbard_satterthwaite import compute_manipulability_index
