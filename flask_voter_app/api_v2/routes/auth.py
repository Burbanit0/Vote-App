"""
api_v2/routes/auth.py — fastapi-users register / login / logout routes.
...
from api_v2.schemas.auth import UserCreate, UserRead
from api_v2.core.users import auth_backend, fastapi_users
