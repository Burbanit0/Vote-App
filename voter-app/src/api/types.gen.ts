...
export interface paths {
    ...
    "/api/v2/election/assembly": {
        ...
        put?: never;
        /**
         * Compose a parliament: votes → seats under PR / FPTP / MMP
         * @description Party-level assembly over one shared electorate. The same voters under
         ...
         */
        post: operations["assembly_endpoint_api_v2_election_assembly_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v2/election/assembly-scorecard": {
        ...
        put?: never;
        /**
         * Monte-Carlo scorecard: six axes × pr/fptp/mmp, every number banded
         * @description Feeds the playground's parliament scorecard + values lens. Axes are
         ...
         */
        post: operations["assembly_scorecard_endpoint_api_v2_election_assembly_scorecard_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v2/election/issue-voting": {
        ...
        put?: never;
        /**
         * Issue-by-issue majorities vs the bundled platform vote
         * @description The bundling problem: a platform can win the election while the majority
         ...
         */
        post: operations["issue_voting_endpoint_api_v2_election_issue_voting_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v2/election/profile-simulate": {
        ...
        put?: never;
        /**
         * Run every method over a configurable preference profile
         * @description The profile-as-interface core: build a profile from the chosen source
         ...
         */
        post: operations["profile_simulate_endpoint_api_v2_election_profile_simulate_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v2/election/structural-fairness": {
        ...
        put?: never;
        /**
         * Structural (un)fairness: malapportionment, efficiency gap, Penrose, cumulative
         * @description The rules AROUND the rule: unequal district populations distort the
         ...
         */
        post: operations["structural_fairness_endpoint_api_v2_election_structural_fairness_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        AssemblyCoalition: {
            ...
            /**
             * Span
             * @description Max pairwise ideological distance inside the coalition.
             */
            span: number;
        };
        /**
         * AssemblyCongruence
         * @description FB-1: how far the elected body sits from the electorate's median.
         */
        AssemblyCongruence: {
            /** Assembly Gap */
            assembly_gap: number;
            /**
             * Assembly Position
             * @description Seat-weighted mean party position.
             */
            ...
            /**
             * Governing Position
             * @description Most cohesive minimal winning coalition, seat-weighted.
             */
        ...
        AssemblyPartyResult: {
            /**
             * District Seats
             * @description District wins (MMP only; 0 otherwise).
             * @default 0
             */
            district_seats: number;
            /** Excluded By Threshold */
        ...
        /**
         * AssemblyPartySpec
         * @description A party placed on the ideological plane (the shared electorate's points
         *     in parliament mode).
         */
        AssemblyPartySpec: {
            /** Name */
        ...
        /**
         * AssemblyRequest
         * @description POST /api/v2/election/assembly — votes → seats under PR / FPTP / MMP.
         *
        ...
        AssemblyRequest: {
            ...
            /**
             * Strategic Desertion
             * @description Duverger demo: voters iteratively desert non-viable parties (FPTP: outside the district top-2; PR/MMP: below the threshold) for their nearest viable party.
             * @default false
             */
             ...
             */
            threshold: number;
            turnout?: components["schemas"]["TurnoutConfig"];
        };
        /** AssemblyResponse */
        AssemblyResponse: {
            /**
             * Assembly Size
             * @description Actual size (MMP overhang can exceed the nominal seats).
             */
            assembly_size: number;
            /**
             * Coalitions
             * @description Minimal winning coalitions, most cohesive first.
             */
            coalitions: components["schemas"]["AssemblyCoalition"][];
            congruence: components["schemas"]["AssemblyCongruence"];
            ...
            /**
             * Mirror
             * @description Ideological-region composition: electorate vs assembly.
             */
            mirror: components["schemas"]["MirrorRegion"][];
            /** Parties */
            parties: components["schemas"]["AssemblyPartyResult"][];
            /** Structure */
            structure: string;
            /**
             * Threshold Waived
             * @description True if no party passed the threshold and it was waived.
             */
         ...
         * @description POST /api/v2/election/assembly-scorecard — six axes × all three structures
        ...
        AssemblyScorecardResponse: {
            ...
            structures: {
                [key: string]: {
                    [key: string]: components["schemas"]["AxisBand"];
                };
            };
        };
        /** AssumptionResult */
        ...
        /**
         * AxisBand
         * @description A scorecard number with its Monte-Carlo band (mean, p10, p90), all in [0,1].
         */
        AxisBand: {
            /** Hi */
            hi: number;
        ...
        /**
         * BallotConfig
         * @description How voters may EXPRESS their preference (frontier FA-1) — half the design
         *     space, separate from the counting rule. Information is lost on purpose.
         */
        BallotConfig: {
            /**
             * Score Levels
             * @description Levels for score ballots.
             * @default 6
             */
            score_levels: number;
            /**
        ...
        /**
         * CommunitySpec
         * @description One bloc of the composed electorate: a Gaussian community with its own
        ...
        CommunitySpec: {
            ...
            /**
             * Spread
             * @description Bloc standard deviation.
             * @default 0.15
             */
            spread: number;
            /**
             * Turnout
             * @description Per-bloc participation propensity.
             * @default 1
             */
            turnout: number;
            /**
             * Weight
             * @description Relative size (sampling weight).
             * @default 1
             */
            weight: number;
            /**
            ...
            /**
             * Z
             * @description 3rd-axis centre (dims=3).
             * @default 0
             */
            z: number;
        };
        ...
        EfficiencyGapOut: {
            /**
             * Gap
             * @description (wasted_a − wasted_b)/two-party total; sign = disadvantage of a.
             */
            gap: number;
            /** Party A */
            party_a: string;
        ...
        /**
         * ElectorateConfig
         * @description The composed electorate (community mixture). When present and mode is
        ...
        ElectorateConfig: {
            /** Communities */
            communities?: components["schemas"]["CommunitySpec"][];
            /**
             * Correlation
             * @description Couples the x↔y axes.
             * @default 0
             */
            correlation: number;
            /**
            ...
            /**
             * Noise
             * @description Global measurement jitter.
             * @default 0
             */
            noise: number;
        };
        ...
        IssueOutcome: {
            ...
            /**
             * Majority
             * @description +1 yes / −1 no, issue-by-issue referendum.
             */
            majority: number;
            /**
             * Winner Plank
             * @description The elected platform's position on this issue.
             */
            winner_plank: number;
            /** Yes Share */
            yes_share: number;
        ...
        /**
         * IssueVotingRequest
         * @description POST /api/v2/election/issue-voting — issue-by-issue majorities vs the
         ...
         */
        IssueVotingRequest: {
            /** @description Composed electorate (community mixture) for spatial mode; overrides `ideology` when mode='composed'. */
            electorate?: components["schemas"]["ElectorateConfig"] | null;
            /**
             * Ideology
             * @default random
            ...
            num_voters: number;
            /** Parties */
            parties?: components["schemas"]["AssemblyPartySpec"][] | null;
            /** Party Names */
            party_names?: string[] | null;
            /** Party Platforms */
            party_platforms?: number[][] | null;
            /**
             * Seed
             * @default 42
             */
        ...
        IssueVotingResponse: {
            ...
            /** Issues */
            issues: components["schemas"]["IssueOutcome"][];
            /** Mode */
            mode: string;
            /** Num Issues */
            num_issues: number;
            ...
            /** Parties */
            parties: components["schemas"]["IssuePartyResult"][];
        };
        /** JAIncoherence */
        JAIncoherence: {
            /** Conclusion */
        ...
        MalapportionmentOut: {
            ...
            /** Min Share Majority Equal */
            min_share_majority_equal: number;
            /** Min Share Majority Skewed */
        ...
        /**
         * MirrorRegion
         * @description FB-1: descriptive representation over the modelled attribute space.
         */
        MirrorRegion: {
            /** Assembly Share */
        ...
        /**
         * ProfileCandidateSpec
         * @description A candidate/party for the profile engine. Adds an optional 3rd axis and a
        ...
        ProfileCandidateSpec: {
            ...
            /**
             * Valence
             * @description Off-ideology quality bonus.
             * @default 0
             */
            valence: number;
            /**
            ...
            /**
             * Y
             * @description Axis 2 position.
             * @default 0
             */
            y: number;
            /**
             * Z
             * @description Axis 3 position (dims=3).
             * @default 0
             */
            z: number;
        };
         ...
         * @description POST /api/v2/election/profile-simulate — the profile-as-interface core.
         *
         ...
         */
        ProfileSimulateRequest: {
            ballot?: components["schemas"]["BallotConfig"];
            /**
             * Behavior
             * @default sincere
             * @enum {string}
             */
            behavior: "sincere" | "strategic" | "mixed";
            /** Candidates */
             ...
             */
            dims: number;
            /** @description Composed electorate (community mixture); shapes the spatial voter cloud and the paradox rate when mode='composed'. */
            electorate?: components["schemas"]["ElectorateConfig"] | null;
            /**
             * Handcrafted Matrix
             ...
             * @enum {string}
             */
            source: "spatial" | "single_peaked" | "impartial" | "iac" | "mallows" | "urn" | "plackett_luce" | "didi" | "stratification" | "handcrafted";
            /**
             * Source Params
             * @description Source knobs: Mallows {phi}, Pólya urn {alpha}, Plackett-Luce {quality}, DiDi {concentration}, stratification {weight}.
             */
            source_params?: {
                [key: string]: number;
            };
         ...
         * @description Per-method winners over the built profile + its 2D embedding + the
         *     paradox/cycle rate read-out.
         */
        ProfileSimulateResponse: {
            /**
             * Ballot Cognitive Load
            ...
            /**
             * Candidate Points
             * @description Candidate 2D points: true positions (spatial) or biplot centroids (non-spatial).
             */
            ...
            /**
             * Display Points
             * @description Per-voter 2D embedding for the map.
             */
            display_points: number[][];
            /**
             * Incompatible Methods
             * @description Methods that cannot honestly run on this ballot (excluded).
             */
            ...
            /**
             * Sample Ballot
             * @description Voter #0's projected ballot.
             */
            sample_ballot: {
                [key: string]: number;
            };
            ...
            /**
             * Winner Flips
             * @description Methods whose winner differs from the full-information ballot.
             */
            winner_flips: string[];
        };
        /**
         ...
         * @description POST /api/v2/election/structural-fairness — malapportionment, efficiency
        ...
        StructuralFairnessResponse: {
            cumulative: components["schemas"]["CumulativeOut"];
            /** Districts */
            districts: number;
            efficiency_gap: components["schemas"]["EfficiencyGapOut"];
            malapportionment: components["schemas"]["MalapportionmentOut"];
            /**
             * Penrose
        ...
        TurnoutConfig: {
             ...
             * @enum {string}
             */
            model: "full" | "alienation" | "indifference";
        };
        /** TyrannyCurvePoint */
        TyrannyCurvePoint: {
            /** Majority Pct */
...
export interface operations {
    ...
    assembly_endpoint_api_v2_election_assembly_post: {
        ...
        responses: {
            /** @description Seats per party, proportionality (Gallagher), fragmentation (effective number of parties), wasted votes, and the minimal winning coalitions. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    assembly_scorecard_endpoint_api_v2_election_assembly_scorecard_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AssemblyScorecardRequest"];
            };
        };
        responses: {
            /** @description Per-structure axis bands (mean/p10/p90 over re-rolled electorates): proportionality, pluralism, effective votes, minority representation, governability, gerrymander resistance. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    issue_voting_endpoint_api_v2_election_issue_voting_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["IssueVotingRequest"];
            };
        };
        responses: {
            /** @description Per-issue referendum majorities, the elected platform, divergences, and the Ostrogorski-paradox flag. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    profile_simulate_endpoint_api_v2_election_profile_simulate_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ProfileSimulateRequest"];
            };
        };
        responses: {
            /** @description Per-method winners, the profile's 2D embedding, and the paradox/cycle rate, for a user-chosen preference source. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    structural_fairness_endpoint_api_v2_election_structural_fairness_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["StructuralFairnessRequest"];
            };
        };
        responses: {
            /** @description Vote-weight distortion under unequal districts, the two-party efficiency gap, citizen-power ratios under three council weightings, and bloc-vs-cumulative at-large seats. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
