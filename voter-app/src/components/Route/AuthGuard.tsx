  ...
  return (
    <div
      style={{
        ...
        borderBottom: '1px solid #9eeaf9',
        position: 'sticky',
        top: 56,
        zIndex: 900,
      }}
      className="py-2 px-3 flex justify-between items-center flex-wrap gap-2"
    >
      <span className="text-sm text-info-emphasis">
        <Trans i18nKey="auth.readOnlyBanner" />
      </span>
