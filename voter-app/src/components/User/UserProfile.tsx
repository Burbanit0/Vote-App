      ...
      <Card className="mt-1">
        <Card.Body>
          ...
          {profile?.participation_details && (
            <div>
              <Card.Text>
                <strong>Voted at:</strong> {profile.participation_details.voter}{' '}
              </Card.Text>
              <Card.Text>
                <strong>Candidated at:</strong> {profile.participation_details.candidate}{' '}
              </Card.Text>
              <Card.Text>
                <strong>Organized:</strong> {profile.participation_details.organizer}{' '}
              </Card.Text>
            </div>
          )}
        </Card.Body>
