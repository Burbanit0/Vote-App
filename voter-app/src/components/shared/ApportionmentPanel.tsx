...
const ApportionmentPanel: React.FC = () => {
  ...
  return (
    <div>
      ...
      {!data && !loading && !error && (
        <Alert variant="info" role="alert">{t('appor.prompt')}</Alert>
      )}
        ...
        <>
          ...
          <div className="mb-3" data-testid="alabama-demo">
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <span style={{ fontSize: '0.8rem' }}>{sliderN} {t('appor.seats')}</span>
            </div>
            {data.results.hamilton?.alabama_paradox && (
              <Alert variant="danger" className="mt-1 py-1" style={{ fontSize: '0.78rem' }}
