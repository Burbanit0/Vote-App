...
const JuryTheoremPanel: React.FC = () => {
  ...
  const [competence, setCompetence] = useState(0.7);
  ...
  return (
    <div>
      ...
      <div className="mb-3 border border-border rounded p-3">
        <label className="mb-1 inline-block font-semibold mb-0" style={{ fontSize: '0.88rem' }}>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={curveData} margin={{ top: 8, right: 16, bottom: 24, left: 0 }}>
                    ...
                    <ReferenceLine
                      ...
                      strokeDasharray="3 2"
                      label={{
                        value: `P=${Math.round(competence * 100)}%`,
                        fontSize: 9,
                        fill: '#6c757d',
                      }}
                    />
