    ...
    panels: [
      {
        id: 'arrow',
        icon: '🏛',
        titleK: 'arrow.pageTitle',
        descK: 'arrow.pageSubtitle',
        border: '#0d6efd',
        color: '#0d6efd',
        body: <ArrowExplorer />,
      },
      {
        id: 'plott',
        icon: '🌀',
        titleK: 'plott.cardTitle',
        descK: 'plott.cardDesc',
        border: '#dc3545',
        color: '#dc3545',
        body: <PlottChaosPanel />,
      },
      {
        id: 'sen',
        icon: '⚖️',
        titleK: 'sen.cardTitle',
        descK: 'sen.cardDesc',
        border: '#ffc107',
        color: '#856404',
        body: <SenParadoxPanel />,
      },
      {
        id: 'judgment',
        icon: '⚖️',
        titleK: 'judg.cardTitle',
        descK: 'judg.cardDesc',
        border: '#0dcaf0',
        color: '#0dcaf0',
        body: <JudgmentAggregationPanel />,
      },
      {
        id: 'agenda',
        icon: '🗓',
        titleK: 'agenda.cardTitle',
        descK: 'agenda.cardDesc',
        border: '#212529',
        body: <AgendaManipulationPanel />,
      },
      {
        id: 'apportionment',
        icon: '📊',
        titleK: 'appor.cardTitle',
        descK: 'appor.cardDesc',
        border: '#6c757d',
        body: <ApportionmentPanel />,
      },
    ],
  },
  {
    ...
    panels: [
      {
        id: 'power',
        icon: '⚡',
        titleK: 'power.cardTitle',
        descK: 'power.cardDesc',
        border: '#198754',
        color: '#198754',
        body: <PowerIndicesPanel />,
      },
      {
        id: 'tyranny',
        icon: '👑',
        titleK: 'tyranny.cardTitle',
        descK: 'tyranny.cardDesc',
        border: '#6f1d1b',
        color: '#6f1d1b',
        body: <MajorityTyrannyPanel />,
      },
      {
        id: 'backsliding',
        icon: '🏚',
        titleK: 'backsliding.cardTitle',
        descK: 'backsliding.cardDesc',
        border: '#842029',
        color: '#842029',
        body: <DemocraticBackslidingPanel />,
      },
      {
        id: 'intergen',
        icon: '🌱',
        titleK: 'intergen.cardTitle',
        descK: 'intergen.cardDesc',
        border: '#0d6efd',
        color: '#0d6efd',
        body: <IntergenerationalPanel />,
      },
    ],
  },
  {
    ...
    panels: [
      {
        id: 'identity',
        icon: '🏳',
        titleK: 'identity.cardTitle',
        descK: 'identity.cardDesc',
        border: '#6610f2',
        color: '#6610f2',
        labTab: 'lab-identity',
      ...
      },
      {
        id: 'episto',
        icon: '🎓',
        titleK: 'episto.cardTitle',
        descK: 'episto.cardDesc',
        border: '#ffc107',
        color: '#856404',
        labTab: 'lab-epistocracy',
        body: <EpistocracyPanel />,
      },
      {
        id: 'will',
        icon: '🌊',
        titleK: 'will.cardTitle',
        descK: 'will.cardDesc',
        border: '#495057',
        color: '#495057',
        labTab: 'lab-collective-will',
        body: <CollectiveWillPanel />,
      },
      {
        id: 'assumptions',
        icon: '🔬',
        titleK: 'assumptions.cardTitle',
        descK: 'assumptions.cardDesc',
        border: '#6c757d',
        color: '#6c757d',
        labTab: 'lab-assumptions',
...
const TheoryPage: React.FC = () => {
  ...
  useMetaTags({
    ...
    description:
      "Explorez le théorème d'impossibilité d'Arrow et les paradoxes de la théorie du choix social.",
  });

  return (
    <PageContainer variant="wide">
      <h2 className="mb-1 text-[1.5rem] font-bold">🏛 {t('theory.pageTitle')}</h2>
      <p className="mb-4 text-[0.9rem] text-muted-foreground">{t('theory.pageSubtitle')}</p>
      ...
      {SECTIONS.map((section) => (
        <section key={section.id} id={`section-${section.id}`} className="mb-12">
          ...
          <p className="mb-4 text-[0.85rem] text-muted-foreground">{t(section.subtitleK)}</p>
          {section.panels.map((p) => (
            <Card
              key={p.id}
              id={`panel-${p.id}`}
