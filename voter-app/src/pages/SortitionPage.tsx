...
const SortitionPage: React.FC = () => {
  ...
  useMetaTags({
    ...
    description:
      'Comparez assemblée élue, tirage au sort pur et tirage au sort stratifié sur les mêmes métriques démocratiques.',
  });
  ...
  return (
    <div data-style="tailwind" className="mx-auto w-full max-w-[960px] px-3 py-6">
      ...
      <p className="mb-6 text-[0.9rem] text-muted-foreground">{t('sortition.pageSubtitle')}</p>
      <ElectionProvider>
        <SortitionPanel />
      </ElectionProvider>
    </div>
