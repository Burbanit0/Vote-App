...
describe('scenariosApi', () => {
  describe('listScenarios', () => {
    it('returns a list of scenarios', async () => {
      ...
      mockAxios.onGet(`${BASE}/api/scenarios/`).reply(200, scenarios);
  ...
  describe('saveScenario', () => {
    it('creates a scenario with given config', async () => {
      ...
      mockAxios.onPost(`${BASE}/api/scenarios/`).reply(200, created);
  ...
  describe('getScenario', () => {
    it('returns a scenario by id', async () => {
      ...
      mockAxios.onGet(`${BASE}/api/scenarios/1`).reply(200, detail);
  ...
  describe('deleteScenario', () => {
    it('deletes a scenario successfully', async () => {
      mockAxios.onDelete(`${BASE}/api/scenarios/1`).reply(204);
