...
export const addVoterToElection = async (id: number) => {
  ...
  try {
    const response = await axios.post(
      `${API_BASE_URL}/elections/${id}/participate`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const addCandidateToElection = async (id: number) => {
  ...
  try {
    const response = await axios.post(
      `${API_BASE_URL}/elections/${id}/register-candidate`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const isParticipating = async (election_id: number): Promise<ParticipationStatus> => {
  ...
  try {
    const response = await axios.get(`${API_BASE_URL}/elections/${election_id}/participation`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const cancelElectionParticipation = async (election_id: number) => {
  ...
  try {
    const response = await axios.post(
      `${API_BASE_URL}/elections/${election_id}/cancel-participation`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const fetchElectionResults = async (election_id: number) => {
  ...
  try {
    const response = await axios.get(`${API_BASE_URL}/elections/${election_id}/results`, {
...
export const updateElection = async (
  electionId: number,
  electionData: UpdateElectionData
): Promise<Election> => {
  const storedUserJSON = localStorage.getItem('user');
  let token = '';
  let storedUser: { access_token: string } | null = null;
