...
export const HISTORICAL_SCENARIOS: Record<string, HistoricalScenario> = {
  france2002: {
    ...
    real_result: {
      ...
      winner:  'Chirac',
      context: 'Chirac 19,9% · Jospin 16,2% · Le Pen 16,9% — Jospin éliminé au 1er tour, Chirac élu avec 82% au 2nd tour.',
    },
    vote_shares: {
      Chirac:      19.9,
      Jospin:      16.2,
    ...
    reference: 'https://fr.wikipedia.org/wiki/%C3%89lection_pr%C3%A9sidentielle_fran%C3%A7aise_de_2002',
  },
  ...
  condorcet_cycle: {
    ...
    real_result: {
      ...
      winner:  '—',
      context: 'Aucun vainqueur de Condorcet n\'existe. Le résultat dépend entièrement de la méthode choisie.',
    },
  ...
  consensus: {
    ...
    real_result: {
      ...
      winner:  'Centre',
      context: 'Le candidat du centre est élu par toutes les méthodes (pluralité, Borda, IRV, Schulze, approbation).',
    },
