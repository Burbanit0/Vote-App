...
> `docker-compose.llm.yml` (image épinglée `vllm/vllm-openai:v0.30.0` depuis le 2026-09-24, `v0.29.0` puis `v0.28.0` avant, sans spéculation n-gram depuis le 2026-09-20, avec spéculation EAGLE-3 depuis le 2026-09-26 ; modèle `Qwen3-8B-AWQ`
