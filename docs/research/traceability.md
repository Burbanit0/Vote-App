...
| Chaos de Plott | — | §3.3 | `plott1967` | prévu |
| Paradoxe List-Pettit | — | §3.4 | `list_pettit2002` | prévu |
| Paradoxe libéral de Sen | — | §3.5 | `sen1970` | prévu |
| Impossibilité d'apportionment (Balinski-Young) | — | §3.6 | `balinski_young1982` | prévu |
...
## Systèmes alternatifs de gouvernance — extensions en cours

| Système | Fichier(s) prévu(s) | THEORY.md | Référence | Statut |
|---|---|---|---|---|
| Liquid Democracy (délégation transitive révocable) — hors périmètre du simulateur polity | `engine/utils/liquid_democracy_utils.py` (à créer) | §7.2 | `blum_zuber2016`, `kahng_mackenzie_procaccia2021` (algorithmique), `kling2015` (limite empirique : super-voters) | prévu |
| Conviction Voting (accumulation continue / seuil dynamique) | `engine/utils/conviction_voting_utils.py` (à créer) | §7.3 | `commons_stack_1hive2019` | prévu |
...
|---|---|---|---|---|
| Sortition | — | §7.1 | — | prévu |
| Conviction Voting | — | §7.3 | — | prévu |
| Deliberative Polling | — | §7.5 | `fishkin1988` | prévu |
| Futarchie | — | §7.6 | — | prévu |
