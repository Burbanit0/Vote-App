...
@sio.event  # type: ignore[misc]  # python-socketio decorators are untyped
async def disconnect(sid: str) -> None:
    """Drop any pending stop flag on disconnect."""
    _stop_flags.pop(sid, None)


@sio.on("stop_monte_carlo")  # type: ignore[misc]  # untyped socketio decorator
...
@sio.on("start_monte_carlo")  # type: ignore[misc]  # untyped socketio decorator
