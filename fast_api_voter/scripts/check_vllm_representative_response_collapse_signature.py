...
Usage:
    python fast_api_voter/scripts/check_vllm_representative_response_collapse_signature.py
"""
...
from api.domain.polity.llm_client import VllmJsonClient, decode_response_batch  # noqa: E402
