"""
scripts/check_vllm_reaction_to_event_collapse_signature.py
...
Usage:
    python fast_api_voter/scripts/check_vllm_reaction_to_event_collapse_signature.py
"""
...
from api.domain.polity.llm_client import VllmJsonClient, decode_reaction_batch  # noqa: E402
